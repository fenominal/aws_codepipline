...
$meta_title="Local Purchase";
$meta_desc="Local Purchase";
$meta_keyword="Local Purchase";
...
<head>
	...
	<link rel="icon" href="images/logo/WhatsApp Image 2020-09-21 at 21.21.43.jpeg" type="image/gif" sizes="16x16">
                    ...
                    <div class="row">
                        <div class="menumenu__container clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5"> 
                                <div class="logo">
                                     <a href="index.php"><img class="img1" src="images/logo/logo.jpg" style="
    border-bottom: 0px;
    border-top: 0px;
    border-radius: 0px;
